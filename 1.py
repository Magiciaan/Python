...
class Student:
	def __init__(self,root):
		...
		title=Label(self.root,text="student management system",bd=10,relief = GROOVE ,font=('Arial',40),bg="orange",fg='White')
...
#varaible 
		...
		m_title=Label(Manage_frame,text ="Manage Students",font=('Arial',20))
		m_title.grid(row=0,columnspan=2,pady=20)

		lbl_roll=Label(Manage_frame,text ="Roll no.",font=('Arial',20))
		...
		lbl_name=Label(Manage_frame,text ="Name.",font=('Arial',20))
		...
		lbl_email=Label(Manage_frame,text ="Email",font=('Arial',20))
		...
		lbl_Gender=Label(Manage_frame,text ="Gender",font=('Arial',20))
